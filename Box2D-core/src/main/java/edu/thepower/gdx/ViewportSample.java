...
public class ViewportSample extends ApplicationAdapter {
	...
	public void create() {
		...
		//viewport = new FillViewport(8, 6); // Rellena toda la pantalla
		viewport = new FitViewport(8, 6); // Mantiene las dimensiones originales
